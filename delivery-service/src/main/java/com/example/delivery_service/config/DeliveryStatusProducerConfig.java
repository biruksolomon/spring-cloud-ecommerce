...
@Configuration
public class DeliveryStatusProducerConfig {

    @Value("${spring.kafka.bootstrap-servers}")
    private String bootstrapServers;

    @Bean
    public ProducerFactory<String, DeliveryStatusEvent> deliveryStatusProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, DeliveryStatusEvent> deliveryStatusKafkaTemplate() {
